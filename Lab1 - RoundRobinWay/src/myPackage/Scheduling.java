package myPackage;// This file contains the main() function for the Scheduling
...
import myPackage.Results;
import myPackage.SchedulingAlgorithm;
import myPackage.sProcess;
...
public class Scheduling {
  ...
  private static String resultsFile = "E:\\MUM Work\\OperatingSystems\\My Assignments\\Labs\\Lab1 - RoundRobinWay\\src\\myPackage\\Summary-Results";
  ...
  public static void main(String[] args) {
    ...
    File f = new File("E:\\MUM Work\\OperatingSystems\\My Assignments\\Labs\\Lab1 - RoundRobinWay\\src\\myPackage\\scheduling.conf");
    if (!(f.exists())) {
    ...
    //This line was changed by aimal
    Init(f.toString());
